...
Source0  : https://files.pythonhosted.org/packages/54/5e/65693b36b6b029e523404817d57b0e71296ae2819ab2b47deedec4632fd5/pypsrp-0.8.0.tar.gz
...
%prep
%setup -q -n pypsrp-0.8.0
cd %{_builddir}/pypsrp-0.8.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1643734347
...
cp %{_builddir}/pypsrp-0.8.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-pypsrp/3feb94e218ec9cc73b84cf413325044398ed1ebb
