...
%prep
%setup -q -n pypsrp-0.6.1
cd %{_builddir}/pypsrp-0.6.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639054568
...
cp %{_builddir}/pypsrp-0.6.1/LICENSE %{buildroot}/usr/share/package-licenses/pypi-pypsrp/3feb94e218ec9cc73b84cf413325044398ed1ebb
